    ...
    <div className={`h-screen w-screen px-40 pt-32 pb-20 ${textColor}`} name="aboutme">
      ...
      <div className='grid grid-cols-2 w-full mt-32'>
        <div className='row-span-1 flex justify-center'>
          <div className='h-56 w-56 overflow-hidden rounded-full inline-block border-2 border-white hover:cursor-pointer transition'>
            <img src={me} className='mb-20 z-[-1]'/>
          </div>
        </div>
        <div className='text-xl font-semibold w-full row-span-1'>
          <p className='w-[600px] leading-10 text-slate-600'>
