...
export default function GetInTouch({ bg, hour2, contactRef }) {
  ...
  return (
    <div ref={contactRef} className='flex items-center max-[1000px]:px-1 max-[1680px]:px-10 max-[1680px]:py-24 min-[1681px]:px-10 min-[1681px]:py-20 flex-col h-full w-screen' name="contact">
      <ToastContainer />
      <div className='text-center'>
        <h1 className='max-[1000px]:text-2xl max-[1680px]:text-4xl min-[1681px]:text-5xl font-bold max-[1680px]:mb-10 min-[1681px]:mb-16'>GET IN TOUCH</h1>
      </div>
      <div className=' min-[1001px]:flex max-[1000px]:w-full'>
        <div className='max-[1000px]:flex max-[1000px]:justify-center'>
          <div className={`shadow-xl max-[1000px]:w-[370px] max-[1680px]:w-[450px] min-[1681px]:w-[600px] max-[1680px]:h-[520px] min-[1681px]:h-[660px] rounded-2xl px-6 py-7 ${hour2 < 4 || hour2 >= 18 ? 'bg-slate-600' : 'bg-slate-900'} bg-opacity-20`}>
            <h1 className='max-[1000px]:text-base max-[1680px]:text-lg min-[1681px]:text-xl font-bold text-center'>Send A Message!</h1>
            ...
            <form ref={form} onSubmit={handleSubmit} className='flex flex-col flex-wrap'>
              ...
              <div className='mt-6'>
                <label className='max-[1000px]:text-sm font-bold max-[1680px]:text-base min-[1681px]:text-lg'>MESSAGE</label>
              ...
              <div className='mt-6'>
                <button className={`flex items-center justify-center max-[1000px]:w-full max-[1000px]:h-10 max-[1681px]:h-4 max-[1681px]:w-20 min-[1681px]:h-8 min-[1681px]:w-24 max-[1680px]:text-sm min-[1681px]:text-base font-bold rounded-3xl max-[1680px]:px-5 max-[1680px]:py-4 min-[1681px]:px-10 min-[1681px]:py-5 ${hour2 < 4 || hour2 >= 18 ? 'bg-yellow-600' : 'bg-yellow-400'} ${hour2 < 4 || hour2 >= 18 ? 'active:bg-yellow-300' : 'active:bg-yellow-600'}`} type='submit'><span>SEND</span></button>
              </div>
            </form>
          </div>
        </div>
        <div className='max-[1000px]:flex max-[1000px]:justify-center max-[1000px]:mt-8'>
          <div className={`h-full max-[1680px]:w-[400px] max-[1000px]:ml-0 min-[1681px]:w-[500px] px-6 rounded-2xl ${hour2 < 4 || hour2 >= 18 ? 'bg-slate-600' : 'bg-slate-900'} bg-opacity-20 ml-7 py-5`}>
