...
export default function ProjectCarousel({ textColor, hour2, projectRef }) {
  ...
  return (
    <div ref={projectRef} className='max-lg:hidden h-screen w-screen max-[1680px]:px-52 max-[1680px]:pt-28 max-[1680px]:pb-24 min-[1681px]:px-72 min-[1681px]:pt-32 min-[1681px]:pb-20 z-[-1]' name='project'>
      ...
      <div className='flex items-center'>
        ...
        >
          ...
          <div className="slider-controler">
            <div className={`swiper-button-prev slider-arrow z-30  ${hour2 < 6 || hour2 >= 18 ? 'text-white' : 'text-black'}`}>
              <FontAwesomeIcon className='' icon={faCircleChevronLeft} />
            </div>
            <div className={`swiper-button-next slider-arrow z-30 ${hour2 < 6 || hour2 >= 18 ? 'text-white' : 'text-black'}`}>
