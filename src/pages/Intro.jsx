...
export default function Intro({ intro, hour2, textColor, introRef }) {
  return (
    <div ref={introRef} className='slide-down h-screen max-md:pb-72 max-md:px-20 max-[1680px]:py-44 max-[1680px]:px-24 min-[1680px]:py-44 min-[1680px]:px-16 flex justify-center select-none' name='intro' >
      <div className='max-[1000px]:mt-5 mt-36'>
        ...
        <h1 className='min-[1001px]:hidden text-2xl flex font-bold '>Hello <span className='mr-3 ml-3'><a href="https://emoji.gg/emoji/2084-heya"><img src="https://cdn3.emoji.gg/emojis/2084-heya.gif" className='w-7 h-7' alt="heya" /></a></span>I'm</h1>
        <h1 className='min-[1001px]:hidden text-3xl font-bold'><span className='txt-outline'>La Ode Abdul Dzarif Imaduddin</span></h1>
        <h1 className='max-[1000px]:mt-2 max-md:text-base [1680px]:text-xl min-[1680px]:text-3xl max-[1680px]:mt-2 min-[1680px]:mt-5 font-semibold'>I'm a
        ...
        <div className='max-[1000px]:mt-8 max-[1680px]:mt-2 min-[1680px]:mt-5'>
